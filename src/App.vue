<template>
    ...
    <div>
        <form @submit.prevent="submitForm">
            ...
            <input class="{'is-invalid':isInvalidName}" type="text" name="nama" v-model="siswa.name">
            <div v-if="isInvalidName" class="eror-message">
            </div>
            <br>
            <label for="">Kelas</label>
            <input class="{'is-invalid':isInvalidKelas}" type="kelas" name="kelas" v-model="siswa.kelas">
            <div v-if="isInvalidkelas" class="eror-message">
            </div>
            <br>
            <label for="">Alamat</label>
            <input class="{'is-invalid':isInvalidAlamat}" type="alamat" name="alamat" v-model="siswa.alamat">
            <div v-if="isInvalidAlamat" class="eror-message">
            </div>
            <br>
            <label for="">Nilai Matematika</label>
            <input class="{'is-invalid':isInvalidMatematika}" type="matematika" name="matematika"
                v-model="siswa.matematika">
            <div v-if="isInvalidMatematika" class="eror-message">
            </div>
            <br>
            <label for="">Nilai Bahasa Indonesia</label>
            <input class="{'is-invalid':isInvalidIndonesia}" type="indonesia" name="indonesia" v-model="siswa.indonesia">
            <div v-if="isInvalidIndonesia" class="eror-message">
            </div>
            <br>
            <label for="">Nilai Ipa</label>
            <input class="{'is-invalid':isInvalidIpa}" type="ipa" name="ipa" v-model="siswa.ipa">
